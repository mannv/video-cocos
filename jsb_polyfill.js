	...
	(function outer(modules, cache, entry) {
		...
		8: [(function (require, module, exports) {
			...
			function cardano(curve, x) {
				...
				var pb3 = 3 * pb;
				var pc3 = 3 * pc;
				var d = -pa + pb3 - pc3 + pd, rd = 1 / d, r3 = 1 / 3, a = (pa3 - 6 * pb + pc3) * rd, a3 = a * r3,
					b = (-pa3 + pb3) * rd, c = pa * rd, p = (3 * b - a * a) * r3, p3 = p * r3,
					q = (2 * a * a * a - 9 * a * b + 27 * c) / 27, q2 = q / 2, discriminant = q2 * q2 + p3 * p3 * p3, u1, v1, x1,
					x2, x3;
				if (discriminant < 0) {
					var mp3 = -p * r3, mp33 = mp3 * mp3 * mp3, r = sqrt(mp33), t = -q / (2 * r),
						cosphi = t < -1 ? -1 : t > 1 ? 1 : t, phi = acos(cosphi), crtr = crt(r), t1 = 2 * crtr;
					x1 = t1 * cos(phi * r3) - a3;
		...
		48: [(function (require, module, exports) {
			...
			"../label/CCSGLabel": 206,
			"../label/CCSGLabelCanvasRenderCmd": 206,
			"../label/CCSGLabelWebGLRenderCmd": 206
		}],
		...
		51: [(function (require, module, exports) {
			...
			var Mask = cc.Class({
				...
				_hitTest: function (point) {
					var size = this.node.getContentSize(), w = size.width, h = size.height,
					...
					if (this.type === MaskType.RECT || this.type === MaskType.IMAGE_STENCIL) {
						...
						var left = point.x - rect.x, right = rect.x + rect.width - point.x, bottom = point.y - rect.y,
			...
			"../../clipping-nodes/CCClippingNode": 206,
			"../../clipping-nodes/CCClippingNodeCanvasRenderCmd": 206,
			"../../clipping-nodes/CCClippingNodeWebGLRenderCmd": 206,
			"../../shape-nodes/CCDrawNode": 206
		}],
		...
		68: [(function (require, module, exports) {
			...
			var VideoPlayer = cc.Class({
				...
				properties: {
					...
					whiteBackground: {
						...
						type: cc.Boolean,
						notify: function () {
							this._sgNode.setWhiteBackgroundEnabled(this.whiteBackground);
						}
					},
					loop: {
						tooltip: false,
						...
						type: cc.Boolean,
						notify: function () {
							this._sgNode.setLoopEnabled(this.loop);
						}
					},
					isFullscreen: {
						tooltip: false,
				...
				_initSgNode: function () {
					...
					if (sgNode) {
						...
						sgNode.setWhiteBackgroundEnabled(this.whiteBackground);
						sgNode.setLoopEnabled(this.loop);
			...
			"../videoplayer/CCSGVideoPlayer": 206
		}],
		...
		104: [(function (require, module, exports) {
			...
			PhysicsContact.prototype.getWorldManifold = function () {
				...
				for (var i = 0; i < count; i++) {
					var _p2 = pointCache[i];
					_p2.x = wrapper.getX(i);
					_p2.y = wrapper.getY(i);
					points[i] = _p2;
		...
		107: [(function (require, module, exports) {
			...
			function Right(a, b, c) {
				if ("undefined" === (__typeofVal = typeof c, "object" === __typeofVal ? __realTypeOfObj(c) : __typeofVal)) {
					var i = a, vertices = b;
					a = At(i - 1, vertices);
					b = At(i, vertices);
					c = At(i + 1, vertices);
		...
		108: [(function (require, module, exports) {
			...
			var RigidBody = cc.Class({
				...
				getJointList: function () {
					...
					for (var i = 0; i < joints.length; i++) joints[i] = joints[i]._joint;
					return joints;
				},
		...
		114: [(function (require, module, exports) {
			...
			"./platform/CCPhysicsAABBQueryCallback": 206,
			"./platform/CCPhysicsContactListner": 206,
			"./platform/CCPhysicsDebugDraw": 206,
			"./platform/CCPhysicsRayCastCallback": 206,
			"./platform/CCPhysicsUtils": 206
		}],
		...
		166: [(function (require, module, exports) {
			...
			"./CCSGMotionStreak": 206,
			"./CCSGMotionStreakWebGLRenderCmd": 206
		}],
		...
		168: [(function (require, module, exports) {
			...
			"./CCParticleAsset": 167,
			"./CCSGParticleSystem": 206,
			"./CCSGParticleSystemCanvasRenderCmd": 206,
			"./CCSGParticleSystemWebGLRenderCmd": 206
		}],
		169: [(function (require, module, exports) {
			...
			"./CCSGTMXLayer": 206,
			"./CCTMXLayerCanvasRenderCmd": 206,
			"./CCTMXLayerWebGLRenderCmd": 206
		}],
		...
		173: [(function (require, module, exports) {
			...
			"./external/chipmunk/chipmunk": 206
		}],
				...
				_refreshSgNode: function () {
					...
					if (sgNode) {
						...
						if (listenersBefore) {
							...
							(true, sgNode.hasEventCallback()) || sgNode.setEventCallback((function (eventObject) {
			...
			sp.Skeleton = cc.Class({
				...
				_createSgNode: function () {
					if (this.skeletonData) {
						...
						if (atlasFile) {
							if ("string" !== (__typeofVal = typeof atlasFile, "object" === __typeofVal ? __realTypeOfObj(atlasFile) : __typeofVal)) {
								cc.errorID(7505);
								return null;
							}
							try {
		...
		182: [(function (require, module, exports) {
			...
			"./SGSkeleton": 206,
			"./SGSkeletonAnimation": 206,
			"./SGSkeletonCanvasRenderCmd": 206,
			"./SGSkeletonTexture": 206,
			"./SGSkeletonWebGLRenderCmd": 206,
			"./Skeleton": 180,
			"./SkeletonData": 181,
			"./lib/spine": 206
		}],
		...
		188: [(function (require, module, exports) {
			...
			proto.removeEvent = function (type, listener, target) {
				...
				noListeners && this.clearEventCallback();
			};
		...
		205: [(function (require, module, exports) {
			...
			window.__decorate = function (decorators, target, key, desc) {
				var c = arguments.length,
					r = c < 3 ? target : null === desc ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
