...
SE_DECLARE_FUNC(js_cocos2dx_experimental_video_VideoPlayer_setWhiteBackgroundEnabled);
SE_DECLARE_FUNC(js_cocos2dx_experimental_video_VideoPlayer_setLoopEnabled);
